...
* Update translations, see [translation_process.md](https://github.com/hiluxcrypto/hilux/blob/master/doc/translation_process.md#syncing-with-transifex)
...
Check out the source code in the following directory hierarchy.
	...
	git clone https://github.com/hiluxcrypto/gitian.sigs.git
...
### Fetch and create inputs: (first time, or when dependency versions change)
	...
	mkdir -p inputs
	wget -P inputs https://hiluxcore.org/cfields/osslsigncode-Backports-to-1.7.1.patch
...
### Build and sign Hilux Core for Linux, Windows, and OS X:
	...
	./bin/gbuild --commit hilux=v${VERSION} ../hilux/contrib/gitian-descriptors/gitian-linux.yml
	...
	./bin/gbuild --commit hilux=v${VERSION} ../hilux/contrib/gitian-descriptors/gitian-win.yml
	...
	./bin/gbuild --commit hilux=v${VERSION} ../hilux/contrib/gitian-descriptors/gitian-osx.yml
...
### Verify other gitian builders signatures to your own. (Optional)
  ...
  Add other gitian builders keys to your gpg keyring
	...
	gpg --import ../hilux/contrib/gitian-downloader/*.pgp
...
Commit your signature to gitian.sigs:
  ...
  Wait for Windows/OS X detached signatures:
	...
	Detached signatures will then be committed to the [hilux-detached-sigs](https://github.com/hiluxcrypto/hilux-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the hilux.org server

- Update hilux.org

- Announce the release:

  - Release on Hilux forum: https://www.hilux.org/forum/topic/official-announcements.54/

  - Hilux-development mailing list

  - Update title of #hiluxcrypto on Freenode IRC

  - Optionally reddit /r/hiluxcrypto, ... but this will usually sort out itself

- Notify flare so that he can start building [the PPAs](https://launchpad.net/~hilux.org/+archive/ubuntu/hilux)
