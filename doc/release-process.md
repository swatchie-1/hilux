...
* Update translations, see [translation_process.md](https://github.com/hilux/hilux/blob/master/doc/translation_process.md#synchronising-translations).

* Update manpages, see [gen-manpages.sh](https://github.com/hilux/hilux/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
Check out the source code in the following directory hierarchy.
	...
	git clone https://github.com/swatchie-1/hilux/hilux-detached-sigs.git
	git clone https://github.com/devrandom/gitian-builder.git
	git clone https://github.com/swatchie-1/hilux/hilux.git
...
- Detached signatures will then be committed to the [hilux-detached-sigs](https://github.com/hilux/hilux-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
space *do not upload these to the hilux.org server*.
...
- Announce the release:
  ...
  - Optionally Discord, twitter, reddit /r/Hiluxpay, ... but this will usually sort out itself
  ...
  - Create a [new GitHub release](https://github.com/hilux/hilux/releases/new) with a link to the archived release notes.
