...
git clone https://github.com/swatchie-1/hilux/
git clone https://github.com/swatchie-1/hilux/gitian.sigs.git
```
...
cd /some/root/path/
git clone https://github.com/swatchie-1/hilux/-detached-sigs.git

BTCPATH=/some/root/path/hilux
SIGPATH=/some/root/path/hilux-detached-sigs

./bin/gbuild --url hilux=${BTCPATH},signature=${SIGPATH} ../hilux/contrib/gitian-descriptors/gitian-win-signer.yml
```
...
[hilux/gitian.sigs](https://github.com/swatchie-1/hilux/gitian.sigs/) repository, or if that's not possible to create a pull
request.
