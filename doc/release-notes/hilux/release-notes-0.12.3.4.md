...
When deployed on testnet, it is required to start with a fresh data directory or call Hilux Core with `-reindex-chainstate`.

0.12.3.4 Change log
===================

See detailed [set of changes](https://github.com/hiluxrunners/hilux/compare/v0.12.3.3...hiluxrunners:v0.12.3.4).
...
- [v0.12.3.3](https://github.com/hiluxrunners/hilux/blob/master/doc/release-notes/hilux/release-notes-0.12.3.3.md) released Sep/19/2018
...
- [v0.12.0](https://github.com/hiluxrunners/hilux/blob/master/doc/release-notes/hilux/release-notes-0.12.0.md) released Aug/15/2015
