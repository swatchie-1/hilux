 ...
 *  We have 4 times smaller block times in Hilux, so we need to push 4 times more invs per 1MB. */
...
/** Absolute maximum transaction fee (in haks) used by wallet and mempool (rejects high fee in sendrawtransaction) */
