...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Hilux related functionality
...
/*
    ...
    allow endless transaction that would bloat Hilux and make it unusable. To
