...
#ifndef HILUX_TEST_SCRIPTNUM10_H
#define HILUX_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Hilux Core 0.10.0, for cross-comparison.
 */
public:
