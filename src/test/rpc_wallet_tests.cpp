...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CHiluxAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CHiluxAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey(0, false);
        demoAddress = CHiluxAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CHiluxAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CHiluxAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CHiluxAddress(arr[0].get_str()).Get() == demoAddress.Get());
