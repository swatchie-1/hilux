...
#define BOOST_TEST_MODULE Hilux Test Suite

#include "test_hilux.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_hilux_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
