...
#ifndef HILUX_QT_HILUXUNITS_H
#define HILUX_QT_HILUXUNITS_H
...
/** Hilux unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class HiluxUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit HiluxUnits(QObject *parent);

    /** Hilux units.
      @note Source: https://en.hilux.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        HLX,
...
typedef HiluxUnits::Unit HiluxUnit;

#endif // HILUX_QT_HILUXUNITS_H
