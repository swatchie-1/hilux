...
void BitcoinGUI::createActions()
{
    ...
    aboutAction->setStatusTip(tr("Show information about Hilux Core"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Hilux command-line options").arg(tr(PACKAGE_NAME)));
...
{
    QString strTitle = tr("Hilux Core"); // default title
