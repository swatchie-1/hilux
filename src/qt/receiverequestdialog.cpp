...
#include "config/hilux-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatHiluxURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + HiluxUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatHiluxURI(info));
}
