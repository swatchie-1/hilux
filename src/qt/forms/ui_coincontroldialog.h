...
public:
    ...
    void setupUi(QDialog *CoinControlDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 HILUX"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 HILUX"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 HILUX"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 HILUX"));
