...
#ifndef UI_TOOLSPAGE_H
#define UI_TOOLSPAGE_H
...
public:
    ...
    QLabel *labelToolsBlockChain;
    QLabel *label_3;
    QLabel *numberOfBlocks;
    QLabel *labelLastBlockTime;
    QLabel *lastBlockTime;
    QLabel *labelToolsMempool;
    ...
    void setupUi(QWidget *ToolsPage)
    {
        if (ToolsPage->objectName().isEmpty())
            ToolsPage->setObjectName(QStringLiteral("ToolsPage"));
        ToolsPage->resize(769, 485);
        verticalLayout_2 = new QVBoxLayout(ToolsPage);
        verticalLayout_2->setObjectName(QStringLiteral("verticalLayout_2"));
        tabWidget = new QTabWidget(ToolsPage);
        ...
        labelToolsGeneral = new QLabel(tab_info);
        labelToolsGeneral->setObjectName(QStringLiteral("labelToolsGeneral"));
        QFont font;
        font.setBold(true);
        font.setWeight(75);
        labelToolsGeneral->setFont(font);

        gridLayout->addWidget(labelToolsGeneral, 0, 0, 1, 2);

        label = new QLabel(tab_info);
        ...
        labelToolsNetwork = new QLabel(tab_info);
        labelToolsNetwork->setObjectName(QStringLiteral("labelToolsNetwork"));
        labelToolsNetwork->setFont(font);

        gridLayout->addWidget(labelToolsNetwork, 7, 0, 1, 2);
        ...
        labelToolsBlockChain = new QLabel(tab_info);
        labelToolsBlockChain->setObjectName(QStringLiteral("labelToolsBlockChain"));
        labelToolsBlockChain->setFont(font);

        gridLayout->addWidget(labelToolsBlockChain, 11, 0, 1, 2);
        ...
        labelToolsMempool = new QLabel(tab_info);
        labelToolsMempool->setObjectName(QStringLiteral("labelToolsMempool"));
        labelToolsMempool->setFont(font);

        gridLayout->addWidget(labelToolsMempool, 14, 0, 1, 2);
        ...
        gridLayout->addLayout(verticalLayoutDebugButton, 18, 0, 3, 1);
        ...
        promptIcon->setMaximumSize(QSize(32, 32));
        ...
        btn_salvagewallet->setGeometry(QRect(10, 100, 301, 43));
        btn_salvagewallet->setMinimumSize(QSize(180, 43));
        btn_rescan = new QPushButton(tab_repair);
        btn_rescan->setObjectName(QStringLiteral("btn_rescan"));
        btn_rescan->setGeometry(QRect(10, 150, 301, 43));
        btn_rescan->setMinimumSize(QSize(180, 43));
        btn_zapwallettxes1 = new QPushButton(tab_repair);
        btn_zapwallettxes1->setObjectName(QStringLiteral("btn_zapwallettxes1"));
        btn_zapwallettxes1->setGeometry(QRect(10, 200, 301, 43));
        btn_zapwallettxes1->setMinimumSize(QSize(180, 43));
        btn_zapwallettxes2 = new QPushButton(tab_repair);
        btn_zapwallettxes2->setObjectName(QStringLiteral("btn_zapwallettxes2"));
        btn_zapwallettxes2->setGeometry(QRect(10, 250, 301, 43));
        btn_zapwallettxes2->setMinimumSize(QSize(180, 43));
        btn_upgradewallet = new QPushButton(tab_repair);
        btn_upgradewallet->setObjectName(QStringLiteral("btn_upgradewallet"));
        btn_upgradewallet->setGeometry(QRect(10, 300, 301, 43));
        btn_upgradewallet->setMinimumSize(QSize(180, 43));
        ...
        btn_reindex->setGeometry(QRect(10, 350, 301, 43));
    ...
    void retranslateUi(QWidget *ToolsPage)
    {
        ToolsPage->setWindowTitle(QApplication::translate("ToolsPage", "Tools window", 0));
        labelToolsGeneral->setText(QApplication::translate("ToolsPage", "General", 0));
        label->setText(QApplication::translate("ToolsPage", "Client name", 0));
        clientName->setText(QApplication::translate("ToolsPage", "N/A", 0));
        label_6->setText(QApplication::translate("ToolsPage", "Client version", 0));
        clientVersion->setText(QApplication::translate("ToolsPage", "N/A", 0));
        labelClientUserAgent->setText(QApplication::translate("ToolsPage", "User Agent", 0));
        clientUserAgent->setText(QApplication::translate("ToolsPage", "N/A", 0));
        label_berkeleyDBVersion->setText(QApplication::translate("ToolsPage", "Using BerkeleyDB version", 0));
        berkeleyDBVersion->setText(QApplication::translate("ToolsPage", "N/A", 0));
        label_12->setText(QApplication::translate("ToolsPage", "Datadir", 0));
        dataDir->setText(QApplication::translate("ToolsPage", "N/A", 0));
        label_13->setText(QApplication::translate("ToolsPage", "Startup time", 0));
        startupTime->setText(QApplication::translate("ToolsPage", "N/A", 0));
        labelToolsNetwork->setText(QApplication::translate("ToolsPage", "Network", 0));
        label_8->setText(QApplication::translate("ToolsPage", "Name", 0));
        networkName->setText(QApplication::translate("ToolsPage", "N/A", 0));
        label_7->setText(QApplication::translate("ToolsPage", "Number of connections", 0));
        numberOfConnections->setText(QApplication::translate("ToolsPage", "N/A", 0));
        masternodeCountLabel->setText(QApplication::translate("ToolsPage", "Number of Masternodes", 0));
        masternodeCount->setText(QApplication::translate("ToolsPage", "N/A", 0));
        labelToolsBlockChain->setText(QApplication::translate("ToolsPage", "Block chain", 0));
        label_3->setText(QApplication::translate("ToolsPage", "Current number of blocks", 0));
        numberOfBlocks->setText(QApplication::translate("ToolsPage", "N/A", 0));
        labelLastBlockTime->setText(QApplication::translate("ToolsPage", "Last block time", 0));
        lastBlockTime->setText(QApplication::translate("ToolsPage", "N/A", 0));
        labelToolsMempool->setText(QApplication::translate("ToolsPage", "Memory Pool", 0));
        labelNumberOfTransactions->setText(QApplication::translate("ToolsPage", "Current number of transactions", 0));
        mempoolNumberTxs->setText(QApplication::translate("ToolsPage", "N/A", 0));
        labelMemoryUsage->setText(QApplication::translate("ToolsPage", "Memory usage", 0));
        mempoolSize->setText(QApplication::translate("ToolsPage", "N/A", 0));
#ifndef QT_NO_TOOLTIP
        openDebugLogfileButton->setToolTip(QApplication::translate("ToolsPage", "Open the Hilux debug log file from the current data directory. This can take a few seconds for large log files.", 0));
#endif // QT_NO_TOOLTIP
        openDebugLogfileButton->setText(QApplication::translate("ToolsPage", "&Open Debug Log File", 0));
        tabWidget->setTabText(tabWidget->indexOf(tab_info), QApplication::translate("ToolsPage", "&Information", 0));
        fontSmallerButton->setText(QString());
#ifndef QT_NO_TOOLTIP
        fontSmallerButton->setToolTip(QApplication::translate("ToolsPage", "Decrease font size", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        fontBiggerButton->setToolTip(QApplication::translate("ToolsPage", "Increase font size", 0));
#endif // QT_NO_TOOLTIP
        fontBiggerButton->setText(QString());
#ifndef QT_NO_TOOLTIP
        clearButton->setToolTip(QApplication::translate("ToolsPage", "Clear console", 0));
#endif // QT_NO_TOOLTIP
        clearButton->setText(QString());
        promptIcon->setText(QString());
        lineEdit->setPlaceholderText(QString());
        tabWidget->setTabText(tabWidget->indexOf(tab_console), QApplication::translate("ToolsPage", "&Console", 0));
        btnClearTrafficGraph->setText(QApplication::translate("ToolsPage", "&Clear", 0));
        groupBox->setTitle(QApplication::translate("ToolsPage", "Totals", 0));
        label_16->setText(QApplication::translate("ToolsPage", "Received", 0));
        label_17->setText(QApplication::translate("ToolsPage", "Sent", 0));
        tabWidget->setTabText(tabWidget->indexOf(tab_nettraffic), QApplication::translate("ToolsPage", "&Network Traffic", 0));
        banHeading->setText(QApplication::translate("ToolsPage", "Banned peers", 0));
        peerHeading->setText(QApplication::translate("ToolsPage", "Select a peer to view detailed information.", 0));
        label_30->setText(QApplication::translate("ToolsPage", "Whitelisted", 0));
        peerWhitelisted->setText(QApplication::translate("ToolsPage", "N/A", 0));
        label_23->setText(QApplication::translate("ToolsPage", "Direction", 0));
        peerDirection->setText(QApplication::translate("ToolsPage", "N/A", 0));
        label_21->setText(QApplication::translate("ToolsPage", "Version", 0));
        peerVersion->setText(QApplication::translate("ToolsPage", "N/A", 0));
        label_28->setText(QApplication::translate("ToolsPage", "User Agent", 0));
        peerSubversion->setText(QApplication::translate("ToolsPage", "N/A", 0));
        label_4->setText(QApplication::translate("ToolsPage", "Services", 0));
        peerServices->setText(QApplication::translate("ToolsPage", "N/A", 0));
        label_29->setText(QApplication::translate("ToolsPage", "Starting Block", 0));
        peerHeight->setText(QApplication::translate("ToolsPage", "N/A", 0));
        label_27->setText(QApplication::translate("ToolsPage", "Synced Headers", 0));
        peerSyncHeight->setText(QApplication::translate("ToolsPage", "N/A", 0));
        label_25->setText(QApplication::translate("ToolsPage", "Synced Blocks", 0));
        peerCommonHeight->setText(QApplication::translate("ToolsPage", "N/A", 0));
        label_24->setText(QApplication::translate("ToolsPage", "Ban Score", 0));
        peerBanScore->setText(QApplication::translate("ToolsPage", "N/A", 0));
        label_22->setText(QApplication::translate("ToolsPage", "Connection Time", 0));
        peerConnTime->setText(QApplication::translate("ToolsPage", "N/A", 0));
        label_15->setText(QApplication::translate("ToolsPage", "Last Send", 0));
        peerLastSend->setText(QApplication::translate("ToolsPage", "N/A", 0));
        label_19->setText(QApplication::translate("ToolsPage", "Last Receive", 0));
        peerLastRecv->setText(QApplication::translate("ToolsPage", "N/A", 0));
        label_18->setText(QApplication::translate("ToolsPage", "Sent", 0));
        peerBytesSent->setText(QApplication::translate("ToolsPage", "N/A", 0));
        label_20->setText(QApplication::translate("ToolsPage", "Received", 0));
        peerBytesRecv->setText(QApplication::translate("ToolsPage", "N/A", 0));
        label_26->setText(QApplication::translate("ToolsPage", "Ping Time", 0));
        peerPingTime->setText(QApplication::translate("ToolsPage", "N/A", 0));
#ifndef QT_NO_TOOLTIP
        peerPingWaitLabel->setToolTip(QApplication::translate("ToolsPage", "The duration of a currently outstanding ping.", 0));
#endif // QT_NO_TOOLTIP
        peerPingWaitLabel->setText(QApplication::translate("ToolsPage", "Ping Wait", 0));
        peerPingWait->setText(QApplication::translate("ToolsPage", "N/A", 0));
        peerMinPingLabel->setText(QApplication::translate("ToolsPage", "Min Ping", 0));
        peerMinPing->setText(QApplication::translate("ToolsPage", "N/A", 0));
        label_timeoffset->setText(QApplication::translate("ToolsPage", "Time Offset", 0));
        timeoffset->setText(QApplication::translate("ToolsPage", "N/A", 0));
        tabWidget->setTabText(tabWidget->indexOf(tab_peers), QApplication::translate("ToolsPage", "&Peers", 0));
        btn_salvagewallet->setText(QApplication::translate("ToolsPage", "Salvage wallet", 0));
        btn_rescan->setText(QApplication::translate("ToolsPage", "Rescan blockchain files", 0));
        btn_zapwallettxes1->setText(QApplication::translate("ToolsPage", "Recover transactions 1", 0));
        btn_zapwallettxes2->setText(QApplication::translate("ToolsPage", "Recover transactions 2", 0));
        btn_upgradewallet->setText(QApplication::translate("ToolsPage", "Upgrade wallet format", 0));
        label_repair_helptext->setText(QApplication::translate("ToolsPage", "The buttons below will restart the wallet with command-line options to repair the wallet, fix issues with corrupt blockhain files or missing/obsolete transactions.", 0));
        label_repair_salvage->setText(QApplication::translate("ToolsPage", "-salvagewallet: Attempt to recover private keys from a corrupt wallet.dat.", 0));
        label_repair_rescan->setText(QApplication::translate("ToolsPage", "-rescan: Rescan the block chain for missing wallet transactions.", 0));
        label_repair_zap1->setText(QApplication::translate("ToolsPage", "-zapwallettxes=1: Recover transactions from blockchain (keep meta-data, e.g. account owner).", 0));
        label_repair_zap2->setText(QApplication::translate("ToolsPage", "-zapwallettxes=2: Recover transactions from blockchain (drop meta-data).", 0));
        label_repair_upgrade->setText(QApplication::translate("ToolsPage", "-upgradewallet: Upgrade wallet to latest format on startup. (Note: this is NOT an update of the wallet itself!)", 0));
        label_repair_header->setText(QApplication::translate("ToolsPage", "Wallet repair options.", 0));
        btn_reindex->setText(QApplication::translate("ToolsPage", "Rebuild index", 0));
        label_repair_reindex->setText(QApplication::translate("ToolsPage", "-reindex: Rebuild block chain index from current blk000??.dat files.", 0));
        wallet_path->setText(QApplication::translate("ToolsPage", "Wallet Path", 0));
        tabWidget->setTabText(tabWidget->indexOf(tab_repair), QApplication::translate("ToolsPage", "&Wallet Repair", 0));
    } // retranslateUi

};

namespace Ui {
    class ToolsPage: public Ui_ToolsPage {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_TOOLSPAGE_H
