    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("HILUX-light"), QVariant("light"));
    ui->theme->addItem(QString("HILUX-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("HILUX-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("HILUX-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("HILUX-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("HILUX-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("HILUX-traditional"), QVariant("trad"));
