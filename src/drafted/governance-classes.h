 ...
 *
 *   // network
 *   CHiluxNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.hilux.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CHiluxNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: HiluxNetwork
// //   -- signature requirements : Key1(User)
// class CHiluxNetworkVariable : public CGovernanceObject
// {
// private:
