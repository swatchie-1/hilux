...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "HiluxNetwork") type = HiluxNetwork;
    if(strType == "HiluxNetworkVariable") type = HiluxNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == HiluxNetwork) s = "HiluxNetwork";
    if(type == HiluxNetworkVariable) s = "HiluxNetworkVariable";
