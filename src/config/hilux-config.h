/* src/config/hilux-config.h.  Generated from hilux-config.h.in by configure.  */
/* src/config/hilux-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef HILUX_CONFIG_H

#define HILUX_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://github.com/hiluxcrypto/hilux/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Hilux Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Hilux Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "hiluxcore"
