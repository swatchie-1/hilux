...
unlocked to sign the Hilux-Qt.app bundle.
...
allowing somebody to distribute a Hilux-Qt.app or hilux-qt-setup.exe with a valid
...
that the hilux-qt.exe file inside the installer had not been tampered with.
