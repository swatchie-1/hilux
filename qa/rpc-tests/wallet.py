...
class WalletTest (BitcoinTestFramework):
    ...
    def run_test (self):
        ...
        # Send 210 HLX from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 1000 HLX in block rewards plus fees, but
        ...
        # Send 100 HLX with subtract fee from amount
        ...
        # Sendmany 100 HLX with subtract fee from amount
