...
ACLOCAL = ${SHELL} /root/hilux5/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /root/hilux5/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /root/hilux5/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /root/hilux5/build-aux/missing automake-1.15
AWK = gawk
BDB_CPPFLAGS = 
...
MAINT = 
MAKEINFO = ${SHELL} /root/hilux5/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
PACKAGE_STRING = Hilux Core 0.1.2
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /root/hilux5
abs_srcdir = /root/hilux5
abs_top_builddir = /root/hilux5
abs_top_srcdir = /root/hilux5
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /root/hilux5/build-aux/install-sh
