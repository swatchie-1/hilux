...
#   HLX: MPF5C1g7T8nwayvoVmaC3Z4upAx5xf4skx
#

RUNAS="root"

COIN_NAME="Hilux Core"
coin_name="hilux"
COIN_DATA="hilux"
COIN_PORT=9898
COIN_RPCPORT=9899
...
COIN_TGZ="https://github.com/hilux/hilux/releases/download/v1.2.3.4/hilux-1.2.3-linux${KERN_ARCH}.tar.gz"
...
function install_sentinel() {
  ...
  local SENTINEL_PATH="sentinel-hilux"
  cd $CONFIGHOME
  git clone https://github.com/hilux/sentinel.git $SENTINEL_PATH
  cd $SENTINEL_PATH
...
function important_information() {
  ...
  echo -e "  HLX: MPF5C1g7T8nwayvoVmaC3Z4upAx5xf4skx"
  echo -e "${GREEN}================================================================================================================================${NC}"
}
