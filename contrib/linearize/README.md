# Linearize
Construct a linear, no-fork, best version of the Hilux blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install x16r_hash

https://github.com/hilux/hilux_hash
...
JSON-RPC server. Running `hiluxd` or `hilux-qt -server` will be sufficient.
...
* `input`: hiluxd blocks/ directory containing blkNNNNN.dat
